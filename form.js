	...
	submit : function() {
		...
		ajax.callbacks.success = function( response ) {
			...
			if ( response.success ) {
				...
				this.messageElement.innerHTML = "<p style='max-width:400px, padding-lef:20px'>Thank you!</p><a href='https://weareplanta.com/wp-content/uploads/2022/09/PLANTA-Sustainable-Accessible-Web-Guide-2.pdf' download style='color:#00E170;'>Link to Guide for Sustainable & Accessible Webs</a><br><a href='https://weareplanta.com/wp-content/uploads/2022/09/PLANTA_Sustainable-Film-and-Events-Guide.pdf' download style='color:#00E170;'>Link to Guide for Sustainable Film Production & Events</a>";
